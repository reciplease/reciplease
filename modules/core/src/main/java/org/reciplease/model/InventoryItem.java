...
public record InventoryItem(
    ...
    public InventoryItem(final String id, final String createdBy, final String houseId, final String name, final String measure,
        ...
        this(id, createdBy, houseId, name, measure, amount, null, expiration, barcode, null, null, null);
    }

    public InventoryItem(final String id, final String createdBy, final String houseId, final String name, final String measure,
                          final Double amount, final LocalDate expiration, final String barcode, final byte[] image) {
        this(id, createdBy, houseId, name, measure, amount, null, expiration, barcode, image, null, null);
    }
    ...
    public InventoryItem(final String id, final String createdBy, final String houseId, final String name, final String measure,
        ...
        this(id, createdBy, houseId, name, measure, amount, remaining, expiration, barcode, null, null, null);
    }

    public InventoryItem(final String id, final String createdBy, final String houseId, final String name, final String measure,
                          final Double amount, final Double remaining, final LocalDate expiration, final String barcode, final byte[] image) {
        this(id, createdBy, houseId, name, measure, amount, remaining, expiration, barcode, image, null, null);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdBy, houseId, name, measure, amount, remaining, expiration, barcode, Arrays.hashCode(image), createdAt, updatedAt);
    }
}
