...
/**
 * A single ingredient placeholder for a planned meal, optionally covered by inventory
 ...
 */
public record PlannedIngredient(RecipeIngredient ingredient, List<InventoryAllocation> allocations) {
