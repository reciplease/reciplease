...
class InventoryItemTest {
    ...
    void remainingDefaultsToAmount() {
        var item = new InventoryItem(null, null, "house-1", "bread", null, "ITEMS", 10d, LocalDate.now(), null);
    ...
    void remainingIsKeptWhenSupplied() {
        var item = new InventoryItem(null, null, "house-1", "bread", null, "ITEMS", 10d, 4d, LocalDate.now(), null);
    ...
    void withIdPreservesBrand() {
        var item = new InventoryItem(null, null, "house-1", "tomato ketchup", "Heinz", "ITEMS", 10d, LocalDate.now(), null);
