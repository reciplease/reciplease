...
class GoogleHealthConnectionRepositoryTest {
    ...
    void saveOverwritesExistingConnectionForSameUser() {
        final var original = googleHealthConnectionRepository.save(new GoogleHealthConnection(
                USER_ID,
                "access-1",
                "refresh-1",
        ...
        final var refreshed = googleHealthConnectionRepository.save(new GoogleHealthConnection(
                USER_ID,
                "access-2",
                "refresh-2",
    ...
    void deleteByUserIdRemovesConnection() {
        googleHealthConnectionRepository.save(new GoogleHealthConnection(
                USER_ID,
                "access-1",
                "refresh-1",
                Instant.parse("2026-07-02T12:00:00Z"),
