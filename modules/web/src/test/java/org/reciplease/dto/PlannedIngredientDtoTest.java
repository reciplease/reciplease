...
class PlannedIngredientDtoTest {
    ...
    void fromEntity() {
        ...
        assertThat(dto.getAllocations(), contains(PantryAllocationDto.from(new PantryAllocation("item-1", "111", 2d))));
    }
    ...
    void toModel() {
        ...
        assertThat(item.allocations(), contains(new PantryAllocation("item-1", null, 2d)));
    }
